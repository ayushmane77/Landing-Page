...
const Footers = () => {
  return (
    <>
        <div className='mb-5 flex gap-5  justify-between p-3 max-sm:flex-col'>
            <div className=' w-1/2 p-3 space-y-4 max-sm:w-[90%] max-sm:space-y-5'>
                <img src="logo.svg" alt="" />
                <h2 className='text-gray-400'>AI writing tool is designed to empower you with exceptional writing capabilities.</h2>
                ...
                <p className='text-gray-400'>AI Tool, LLC. All rights reserved.</p>
                

                
            </div>

            <div className=' flex justify-around gap-6 w-1/2 p-3 max-sm:flex-col max-sm:gap-8'>
                <div className='space-y-3 text-gray-400 '>
                    <h2 className='font-bold text-white'>Products</h2>
                    <h4 className='hover:text-white'>Features</h4>
                    <h4 className='hover:text-white'>Integration</h4>
                    <h4 className='hover:text-white'>Pricing</h4>
                    <h4 className='hover:text-white'>Changelog</h4>
                    <h4 className='hover:text-white'>Roadmap</h4>
                </div>

                <div className='space-y-3 text-gray-400'>
                    <h2 className='font-bold text-white'>Company</h2>
                    <h4 className='hover:text-white'>Privacy Policy</h4>
                    <h4 className='hover:text-white'>Refuncd Policy</h4>
                    <h4 className='hover:text-white'>Support </h4>
                    <h4 className='hover:text-white'>Changelog</h4>
                </div>
